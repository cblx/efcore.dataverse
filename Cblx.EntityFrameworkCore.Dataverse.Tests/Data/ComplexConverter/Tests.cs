...
//        var id = ThingId.New();
//        var thing = new Thing { Id = id, Name = [Letter.T,Letter.E,Letter.S,Letter.T] };
//        var id2 = ThingId.New();
//        var thing2 = new Thing { Id = id2, Name = [Letter.T, Letter.E, Letter.S, Letter.T, Letter.B] };
...
//            context.Things.Add(new Thing { Id = ThingId.New(), Name = [Letter.T, Letter.E, Letter.S, Letter.T] }); // TODO: We're not cleaning up this thing after the test.
...
//        childThing!.Name.Should().BeEquivalentTo([Letter.C, Letter.H]);
...
//        var childThing = new Thing { Name = [Letter.C, Letter.H], ParentId = thingId };
//        using var db = CreateContext();
...
//        thing!.Name.Should().BeEquivalentTo([Letter.T, Letter.E, Letter.S, Letter.T, Letter.B]);
//    }
...
//        using var db = CreateContext();
//        var thing = await db.Things.FindAsync(thingId);
//        thing!.Name = [Letter.T, Letter.E, Letter.S, Letter.T, Letter.B];
//        await db.SaveChangesAsync();
//    }
...
//        var thing = await db.Things.FindAsync(thingId);
//        thing.Should().NotBeNull();
//        thing!.Name.Should().BeEquivalentTo([Letter.T, Letter.E, Letter.S, Letter.T]);
//    }

//    private static async Task<ThingId> CreateAThing()
//    {
//        var thing = new Thing { Name = [Letter.T, Letter.E, Letter.S, Letter.T] };
//        using var db = CreateContext();
//        db.Things.Add(thing);
//        await db.SaveChangesAsync();
//        return thing.Id;
